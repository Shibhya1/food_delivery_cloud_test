                ...
                <div id="carouselExampleFade" className="carousel slide carousel-fade"  >
                    ...
                    <div className="carousel-inner" id="carousel">
                        ...
                        <div className="carousel-item active">
                            <img src="https://source.unsplash.com/random/900x700/?burger" className="d-block w-100" alt="..." style={{ filter: "brightness(30%)" }}></img>
                        </div>
                        <div className="carousel-item">
                            <img src="https://source.unsplash.com/random/900x700/?pizza" className="d-block w-100" alt="..." style={{
                                filter: "brightness(30%)",
                                objectFit: "contain !important"
                            }}></img>
                        </div>
                        <div className="carousel-item">
                            <img src="https://source.unsplash.com/random/900x700/?fries" className="d-block w-100" alt="..." style={{
                                filter: "brightness(30%)",
                                objectFit: "contain !important"
                            }}></img>
                        </div>
